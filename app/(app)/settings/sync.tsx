...
import { getLastSyncedAt } from '@/features/sync/syncConfig';
...
export default function SyncScreen() {
  ...
  const syncMutation = useMutation({
    mutationFn: (pin: string) => syncNow(restaurantId, pin),
    onSuccess: (result) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <PinOverrideModal
        ...
        message="Enter your PIN to back this restaurant's data up to the cloud."
        managerOnly={false}
        onApprove={(_approverId, _reason, pin) => {
